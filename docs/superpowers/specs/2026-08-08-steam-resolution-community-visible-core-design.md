...
|---|---|---|
| Steam resolution + Fix match | `31` / `1.1.3-rc5` through latched-review correction `37` / `1.1.3-rc11`; `35` / RC9 was withheld | `v1.1.3-rc5` through `v1.1.3-rc11`; only published releases count as acceptance candidates |
