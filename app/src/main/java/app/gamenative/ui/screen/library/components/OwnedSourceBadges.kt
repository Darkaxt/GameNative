...
@Composable
internal fun OwnedSourceCopiesAction(
    sources: List<GameSource>,
    onClick: () -> Unit,
    modifier: Modifier = Modifier,
    iconSize: Int = 12,
) {
    val actionLabel = stringResource(R.string.canonical_copies_action)
    Box(
        modifier = modifier
        ...
        OwnedSourceBadges(sources = sources, iconSize = iconSize)
    }
}
